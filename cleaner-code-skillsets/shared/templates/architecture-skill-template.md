...
- `Decision Process`: require `cleaner-code-skillsets/shared/references/architecture-decision-rubric.md`.
- `Output`: follow `cleaner-code-skillsets/shared/references/architecture-output-contract.md`.
