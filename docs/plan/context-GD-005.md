...
- `cleaner-code-skillsets/design-patterns/structural/bridge/SKILL.md`
- `cleaner-code-skillsets/design-patterns/structural/composite/SKILL.md`
- `cleaner-code-skillsets/design-patterns/structural/decorator/SKILL.md`
- `cleaner-code-skillsets/design-patterns/structural/facade/SKILL.md`
- `cleaner-code-skillsets/design-patterns/structural/flyweight/SKILL.md`
- `cleaner-code-skillsets/design-patterns/structural/proxy/SKILL.md`
- `docs/plan/goal-progression.md`
- `docs/plan/context-GD-005.md`

## Handoff Notes

The next loop should read `docs/plan/goal-progression.md`, select GD-006, and create `cleaner-code-skillsets/design-patterns/behavioral/chain-of-responsibility/SKILL.md`.
...
- File existence:
  `find cleaner-code-skillsets/design-patterns/structural -mindepth 2 -maxdepth 2 -name SKILL.md -type f | sort`
  returned Adapter, Bridge, Composite, Decorator, Facade, Flyweight, and Proxy.
- Frontmatter:
  `rg -n "^name: |^description: Use when" cleaner-code-skillsets/design-patterns/structural/*/SKILL.md`
...
- Refusal criteria, behavior protection, and output contract:
  `rg -n "## Do Not Use When|tests|characterization|pattern-output-contract|Use simpler refactor|Do not change" cleaner-code-skillsets/design-patterns/structural/*/SKILL.md`
