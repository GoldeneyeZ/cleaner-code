...
- `skillsets/design-patterns/creational/abstract-factory/SKILL.md`
- `skillsets/design-patterns/creational/builder/SKILL.md`
- `skillsets/design-patterns/creational/factory-method/SKILL.md`
- `skillsets/design-patterns/creational/prototype/SKILL.md`
- `skillsets/design-patterns/creational/singleton/SKILL.md`
- `docs/plan/goal-progression.md`
- `docs/plan/context-GD-004.md`

## Handoff Notes

The next loop should read `docs/plan/goal-progression.md`, select GD-005, and confirm `skillsets/design-patterns/structural/adapter/SKILL.md` is complete.
...
- File existence:
  `find skillsets/design-patterns/creational -mindepth 2 -maxdepth 2 -name SKILL.md -type f | sort`
  returned Abstract Factory, Builder, Factory Method, Prototype, and Singleton.
- Frontmatter:
  `rg -n "^name: |^description: Use when" skillsets/design-patterns/creational/*/SKILL.md`
...
- Refusal criteria, behavior protection, and output contract:
  `rg -n "## Do Not Use When|tests|characterization|pattern-output-contract|Use simpler refactor|Do not change" skillsets/design-patterns/creational/*/SKILL.md`
